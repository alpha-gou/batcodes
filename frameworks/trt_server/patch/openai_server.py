...
class OpenAIServer:
    ...
    def register_routes(self):
        ...
        self.app.add_api_route("/runtime-metrics", self.ready, methods=["GET"])
        # self.app.add_api_route("/v1/ready", self.health_generate, methods=["GET"])
    ...
    async def openai_chat(self, request: ChatCompletionRequest, raw_request: Request) -> Response:
        ...
        try:
            ...
            # print(request, self.model_config)
