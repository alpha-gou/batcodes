...
PORT=8077                                    # 服务监听端口（官方推荐 8077）
MODEL_NAME=GLM-5.2-W8A8                      # 模型名称
NIC_NAME="eth0"                         # 网络接口名，通过 ifconfig 获取
LOCAL_IP="192.168.XX.X1"                    # 当前节点 IP
NODE0_IP="192.168.XX.X1"                    # 主节点 IP（此处与 LOCAL_IP 相同）
# ==================================================
...
echo ""
echo "✅ 节点 0 容器 '$NAME' 已启动，API 服务端口: $PORT"
